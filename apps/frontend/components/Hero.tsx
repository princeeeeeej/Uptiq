    ...
    >
      ...
      <div className="hero-bg absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(124,58,237,0.5) 0%, rgba(56,189,248,0.2) 50%, transparent 70%)",
          }}
        />
        {}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(168,85,247,0.7) 0%, rgba(99,102,241,0.5) 40%, transparent 80%)",
          }}
        />
        {}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(255,255,255,0.9) 0%, rgba(139,92,246,0.8) 30%, rgba(56,189,248,0.4) 60%, transparent 80%)",
          }}
        />
        {}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, #ffffff 0%, #a78bfa 40%, transparent 80%)",
          }}
        />
        {}
        <div
          ...
          style={{
            background:
              "radial-gradient(ellipse, rgba(255,255,255,1) 0%, rgba(216,180,254,1) 20%, rgba(139,92,246,0.8) 50%, transparent 80%)",
          }}
        />
      </div>
              ...
              <div className="flex-1 px-4 py-6 md:p-6 flex flex-col gap-5 overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-4">
                  ...
                  <div className="bg-[#10b981] rounded-2xl p-4 border border-[#10b981] flex items-center justify-between relative overflow-hidden group hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_0_40px_rgba(16,185,129,0.3)] transition-all duration-300 shadow-[0_0_20px_rgba(16,185,129,0.15)] cursor-pointer">
                    ...
                    <div className="relative z-10">
                      <p className="text-emerald-950/80 text-xs font-medium mb-1 group-hover:text-emerald-950 transition-colors">
                        System Status
                      </p>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {[
                    ...
                    <div
                      key={monitor.name}
                      className="bg-[#121214] border border-white/5 rounded-2xl p-4 hover:border-emerald-500/30 transition-all hover:shadow-[0_0_30px_rgba(16,185,129,0.1)] hover:-translate-y-1 duration-300 group cursor-pointer relative overflow-hidden"
                    >
                      ...
                      <div className="grid grid-cols-2 gap-2 mt-4 relative z-10">
                        <div className="bg-[#18181b] rounded-xl p-2 border border-white/5 group-hover:border-white/10 transition-colors">
                          <p className="text-[9px] text-zinc-500 mb-0.5 flex items-center gap-1">
                            <Activity className="w-2.5 h-2.5 text-emerald-500/50 group-hover:text-emerald-400 transition-colors" />{" "}
                            RESPONSE
                          </p>
                        ...
                        <div className="bg-[#18181b] rounded-xl p-2 border border-white/5 group-hover:border-white/10 transition-colors">
                          <p className="text-[9px] text-zinc-500 mb-0.5 flex items-center gap-1">
                            <svg
                              ...
                              stroke="currentColor"
                              strokeWidth="2"
                              className="text-sky-500/50 group-hover:text-sky-400 transition-colors"
                            >
                  ...
                  <div className="flex flex-col items-center justify-center h-full min-h-[140px] bg-[#121214] border border-white/10 border-dashed rounded-2xl hover:border-emerald-500/50 hover:bg-emerald-500/5 transition-all cursor-pointer group">
                    ...
                    <span className="font-medium text-xs text-white group-hover:text-emerald-400 transition-colors">
                      Add New Monitor
                    </span>
                  </div>
                </div>
